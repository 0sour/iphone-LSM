...
- [ ] **自定义常用地点** — 允许用户自行添加、编辑、删除常用坐标预设
- [ ] **右侧地图点击选择位置** — 在地图上直接点击选取坐标，无需手动输入经纬度
- [ ] **「生成 GPX」标签页功能优化** — 增强轨迹生成能力，支持更丰富的路线参数
- [ ] **「轨迹模拟」标签页功能优化** — 改进轨迹播放控制与交互体验
- [ ] **右侧地图添加搜索功能** — 在地图中搜索地点名称，自动定位到对应坐标
